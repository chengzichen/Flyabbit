...
public class RSAUtil {
    ...
    /**
     * Base64转码时的flag设置，默认为Base64.DEFAULT
     */
    private static int sBase64Mode = Base64.NO_PADDING|Base64.URL_SAFE;
    ...
    public static byte[] decryptByPrivateKey(byte[] encryptedData, String privateKey)
        ...
        Cipher cipher = Cipher.getInstance("RSA/None/PKCS1Padding");//解决乱码问题
