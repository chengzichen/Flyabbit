...
public class CustomPickerView extends View {
    ...
    private String TAG = CustomPickerView.class.getSimpleName();
    ...
    private float mMaxTextAlpha = 90;
     ...
     */
    private void drawOtherText(Canvas canvas, int position, int type,int op)
    {
        ...
        if (op == 1){
            ...
            canvas.drawText(mDataList.get(mCurrentSelected + type * (position-1) ),
                    (float) (mViewWidth / 2.0), baseline, mPaint);
        }
    }
