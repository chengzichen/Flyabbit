...
public class IdentityImageView extends ViewGroup {
    ...
    private double angle = 310; //标识角度大小
    ...
    protected void onLayout(boolean b, int i, int i1, int i2, int i3) {
        ...
        double tvleft = totalwidth / 2 + (radius * cos - tvwidth / 2);
        double tvtop = totalwidth / 2 + (radius * sin - tvHeight / 2);
        int tvright = (int) (tvleft + tvwidth);
        int tvbottom = (int) (tvtop + tvHeight);
        ...
        textView.layout((int) tvleft, (int) tvtop, tvright, tvbottom);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        angle = tta.getFloat(R.styleable.IdentityImageView_iciv_angle, 310);//小图以及进度条起始角度
