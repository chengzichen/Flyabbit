package com.dhc.lib.widget.loadview;
...
class LoaderController {
    ...
    public void onDraw(Canvas canvas, float left_pad, float top_pad, float right_pad, float bottom_pad) {
        ...
        //        RectF rectF=     new RectF(0 + left_pad,  margin_height + top_pad,canvas.getWidth() * widthWeight - right_pad,canvas.getHeight() - margin_height - bottom_pad);
        canvas.drawRect(0 + left_pad,
                ...
                rectPaint);
        //        canvas.drawRoundRect(rectF,20,20,rectPaint);
    }
