...
public class SupportFragment extends RxFragment implements ISupportFragment {
    ...
    protected boolean isSupportHidden() {
        return mIsHidden;
    }
    ...
    @Override
    public void startWithPop(SupportFragment toFragment, @LaunchMode final int launchMode) {
        mFragmentationDelegate.dispatchStartTransaction(getFragmentManager(), this, toFragment, 0, launchMode, FragmentationDelegate.TYPE_ADD_WITH_POP);
    }
