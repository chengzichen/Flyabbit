...
public class SupportActivity extends RxAppCompatActivity implements ISupport, SensorEventListener {
    ...
    @Override
    public void startWithPop(SupportFragment toFragment, @SupportFragment.LaunchMode int launchMode) {
        mFragmentationDelegate.dispatchStartTransaction(getSupportFragmentManager(), getTopFragment(), toFragment, launchMode, SupportFragment.STANDARD, FragmentationDelegate.TYPE_ADD_WITH_POP);
    }
    /**
     * 得到位于栈顶Fragment
     */
