...
package com.dhc.library.rxpermissions;
...
public class RxPermissions {
    ...
    public  interface  DialogCallBlack{
        void onBtnClickL();
        void onBtnClickR();
    }
    public void materialDialogDefault( String msg, DialogCallBlack dialogCallBlack) {
        ...
        dialog.setOnBtnClickL(
                new OnBtnClickL() {
                    ...
                    public void onBtnClick() {
                        if(dialogCallBlack!=null)
                            dialogCallBlack.onBtnClickL();
                        dialog.dismiss();
                    }
                },
                new OnBtnClickL() {
